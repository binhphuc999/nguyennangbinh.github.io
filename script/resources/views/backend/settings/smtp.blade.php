...
<section class="section">
  ...
  <div class="section-body">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <form action="{{ route('settings.smtp.update')}}" method="POST" autocomplete="on" enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="form-group row align-items-center">
                ...
                <div class="col-sm-6 col-md-9">
                  <input type="text" name="MAIL_MAILER" class="form-control @error('MAIL_MAILER') is-invalid @enderror"
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Password')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Encryption')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('From Email Address')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('To Email Address')}}</label>
                <div class="col-sm-6 col-md-9">
                  ...
                  @enderror
                  <small class="form-text text-muted">
                    {{__('This is email where you will receive any new message from the contact form')}}
                  </small>
                </div>
              </div>
