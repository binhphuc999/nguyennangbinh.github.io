          ...
          <div class="card" id="settings-card">
            ...
            <div class="card-body">
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Site Title')}}</label>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Site Url')}}</label>
                <div class="col-sm-6 col-md-9">
                  <input type="url" name="site_url" class="form-control @error('site_url') is-invalid @enderror"
                    required value="{{$setting['site_url']}}">
                  @error('site_url')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
              ...
              <div class="form-group row align-items-center">
                ...
                <div class="col-sm-6 col-md-5">
                  ...
                  <div class="form-text text-muted">{{__('The Logo must have a maximum size of 1MB')}}</div>
                  <div class="mb-3">
                    <input type="hidden" class="form-control @error('site_logo') is-invalid @enderror">
                    @error('site_logo')
                    <div class="invalid-feedback">
                      <strong>{{ $message }}</strong>
                    </div>
              ...
              <div class="form-group row align-items-center">
                ...
                <div class="col-sm-6 col-md-5">
                  ...
                  <div class="form-text text-muted">{{__('The Favicon must have a maximum size of 1MB')}}</div>
                  <div class="mb-3">
                    <input type="hidden" class="form-control @error('favicon') is-invalid @enderror">
                    @error('favicon')
                    <div class="invalid-feedback">
                      <strong>{{ $message }}</strong>
                    </div>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Main Color')}}</label>
      ...
      <div class="col-md-8">
        <form action="{{ route('settings.general.update2')}}" method="POST" autocomplete="on"
          ...
          <div class="card" id="settings-card">
            ...
            <div class="card-body">
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('IMAP Host')}}</label>
                <div class="col-sm-6 col-md-9">
                  <input type="text" name="imap_host" class="form-control @error('imap_host') is-invalid @enderror"
                    required value="{{$setting['imap_host']}}">
                  @error('imap_host')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('IMAP Port')}}</label>
                <div class="col-sm-6 col-md-9">
                  <input type="text" name="imap_port" class="form-control @error('imap_port') is-invalid @enderror"
                    required value="{{$setting['imap_port']}}">
                  @error('imap_port')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('IMAP Encryption')}}</label>
                <div class="col-sm-6 col-md-9">
                  <select class="form-control selectric" name="imap_encryption" id="encryption">
                    <option value="notls" {{ $setting['imap_encryption'] == 'notls' ? 'selected' : '' }}>{{__('None')}}</option>
                    <option value="ssl" {{ $setting['imap_encryption'] == 'ssl' ? 'selected' : '' }}>{{__('SSL')}}</option>
                    <option value="tls" {{ $setting['imap_encryption'] == 'tls' ? 'selected' : '' }}>{{__('TLS')}}</option>
                  </select>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Validate Certificates')}}</label>
                <div class="col-sm-6 col-md-9">
                  <label class="custom-switch ">
                    <input type="checkbox" name="imap_certificate" class="custom-switch-input" value="1"
                      @if($setting['imap_certificate']) checked @endif>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('IMAP Username')}}</label>
                <div class="col-sm-6 col-md-9">
                  <input type="text" name="imap_user" class="form-control @error('imap_user') is-invalid @enderror"
                    required value="{{$setting['imap_user']}}">
                  @error('imap_user')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('IMAP Password')}}</label>
                <div class="col-sm-6 col-md-9">
                  <input type="password" autocomplete="current-password" name="imap_pass" class="form-control @error('imap_pass') is-invalid @enderror"
                    required value="{{$setting['imap_pass']}}">
                  @error('imap_pass')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Email Lifetime')}}
                  ({{__('Days')}})
                  :</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Fetch Mail Every')}}
                  ({{__('Seconds')}})
                  :</label>
                <div class="col-sm-6 col-md-9">
                  <input type="number" name="fetch_time" class="form-control @error('fetch_time') is-invalid @enderror"
                    required value="{{$setting['fetch_time']}}">
                  @error('fetch_time')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Domains')}}</label>
                <div class="col-sm-6 col-md-9">
                  ...
                  @enderror
                  <small class="form-text text-muted">
                    {{__('Add Domains Without "https://" , "/" like (site.com , example.com , yourdomain.com) ')}}
                  </small>
                </div>
              </div>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('Allowed files')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('Fake Emails Created')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('Fake Messages Received')}}</label>
                <div class="col-sm-6 col-md-9">
