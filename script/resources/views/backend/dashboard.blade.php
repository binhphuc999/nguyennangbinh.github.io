  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      <div class="alert alert-danger" role="alert">
        {{__('Please set your IMAP information')}} <a href="{{route('settings.general')}}" class="alert-link">{{__('Set Up Now')}}</a>
      </div>
    </div>
    @endif
    ...
    <div class="col-lg-12">
      <div class="alert alert-warning" role="alert">
        {{__('Please set your SMTP information')}} <a href="{{route('settings.smtp')}}" class="alert-link">{{__('Set Up Now')}}</a>
      </div>
    </div>
    @endif
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="alert alert-success" role="alert">
        ...
        <code>/usr/local/bin/php {{base_path()}}/artisan schedule:run >> /dev/null 2>&1	</code>
      </div>
    </div>
  </div>
</section>
