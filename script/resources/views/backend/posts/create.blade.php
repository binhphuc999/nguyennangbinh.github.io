    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('posts.store')}}" method="POST" autocomplete="on" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{__('Description')}} (max:200)</label>
                <div class="col-sm-12 col-md-7">
