...
@section('title', $tran['Change E-mail Address'] . " | ")
      ...
      <div class="col-md-8 col-sm-12 mb-3">
        <div class="card mb-2">
          <div class="card-header">
            <div class="row">
              <div class="col-6 text-left">{{$tran['Change E-mail Address']}} - {{$setdata['name']}}</div>
            </div>
          </div>
          <div class="card-body">
            <div class="change_email">
              <p>
                {!! $tran['Change Description'] !!}
              </p>
              <form action="{{route("create")}}" method="post" class="col-md-8 col-sm-12 align-items-center">
                ...
                <div class="form-group">
                  <input type="text" required name="name" class="form-control  @error('name') is-invalid @enderror"
                    placeholder="Enter Your Mail!" value="{{old('name')}}">
                  @error('name')
                ...
                <button type="submit" class="btn btn-2">{{__('Chnage')}}</button>
                @if (session()->has('error'))
                <div class="invalid-feedback d_none">
